...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('RECEIVED', 'SEARCHING', 'PENDING', 'STAGED', 'DOWNLOADING', 'COMPLETED', 'FAILED', name='requeststatus'), nullable=False),
    ...
    sa.Column('rule_type', sa.Enum('EXCLUSION', 'REQUIREMENT', 'SCORER', name='ruletype'), nullable=False),
    ...
    op.create_table('staged_torrents',
    sa.Column('id', sa.Integer(), nullable=False),
