...
from app.arbitratarr import version as version_module
...
def test_get_version_uses_installed_package_metadata(monkeypatch):
    ...
    monkeypatch.delenv("ARBITRATARR_VERSION", raising=False)
...
def test_get_version_falls_back_to_environment_variable(monkeypatch):
    ...
    monkeypatch.setenv("ARBITRATARR_VERSION", "v1.2.3")
    monkeypatch.setattr(
